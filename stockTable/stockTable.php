...
echo "<tbody>";
    ...
    <tr>
        ...
        <a style='text-decoration:none' href = './crud/update.php? upadateId=".$row['itemNo']."' class='text-light'  disabled>Update</a>
        </button>
        
       

     
        <button type='button' class='btn btn-danger'  data-bs-toggle='modal' data-bs-target='#exampleModal".$row['itemNo']."'  disabled>
        Delete
      </button>
