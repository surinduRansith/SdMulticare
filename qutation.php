...
$phoneNumber=$_POST['phoneNumber'];
  foreach($cartList as $index) {
      ...
      $quantity = $_POST['quantity'][$index];
      $total = $quantity * $stockArray[$index]['SellingPrice'];
      $fullTotal1 += intval($total);
  
      $itemNoarry[] = array(
          'itemNo' => $stockArray[$index]['itemNo'],
          'itemName' => $stockArray[$index]['ItemName'],
          'itemqty' => $quantity,
          'discountType' => $_POST['discounttype'],
  ...
  $itemNoJson = urlencode(json_encode($itemNoarry));
  
  // Append the JSON string to the URL
  $url = "/sd_multicare/reportsPdf/qutaiongenerate.php?itemNO=" . $itemNoJson;
  ...
  $submited = true;
  $inValid = true;
  $errorEvent = "Please Enter Quote Bill NO";}
            ...
            <form method="post">
                ...
                <div class="row align-items-start">
                    <div class="col input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Quotation No</span>
