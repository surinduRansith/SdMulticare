    ...
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col">
                ...
                <div>
                    <a data-bs-toggle="modal" data-bs-target="#ReloadModal" data-bs-whatever="@mdo"><img
                            src="./assets/Images/reload.png" alt="invoice" class="img-fluid rounded-5"
                    ...
                    <div class="modal fade" id="ReloadModal" tabindex="-1" aria-labelledby="ReloadModalLabel"
                        aria-hidden="true">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" name="submitreload" class="btn btn-primary" id="submitButton">Add</button>
            ...
            <div class="col">
                ...
                <div>
                    <a data-bs-toggle="modal" data-bs-target="#PrintModal" data-bs-whatever="@mdo"><img
                            src="./assets/Images/298915599_380665014220845_614254535053325149_n.png" alt="invoice"
                            class="img-fluid rounded-5" style="width:300px; height: 300px;">
...
<div class="modal-footer">
    ...
    <button type="submit" name="submitprint" class="btn btn-primary" id="submitButtonPrint">Add</button>
            ...
            <div class="col">
                ...
                <div>
                    <a href="accesoriess.php" style="text-decoration:none"><img src="./assets/Images/accessories.jpg"
                            alt="invoice" class=" rounded-5 img-fluid" style="width:300px; height: 300px;">
