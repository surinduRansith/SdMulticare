...
<body class="bg-secondary">
    <div class="container text-center position-absolute top-50 start-50 translate-middle w-25 p-3 border border-warning rounded">
        <form method="post">
            <div>
                <img src="./assets/Images/sdlogo.jpeg" alt="invoice" class="img-fluid" style="width:150px; height: 150px;">
            </div>
            <br>
            <?php
            ...
            <br>
            <div>
                <input type="text" name="username" class="form-control " placeholder="Username" value="<?php echo $setusername; ?>">
            </div>
            <br>
            <br>
            <div>
